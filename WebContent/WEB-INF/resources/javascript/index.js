	...
	case 'LOGGER_FORM_KEYPRESS':
		...
		default:
			...
			case 'F1':
				...
				case 'BCCI': case 'TRI_SERIES': case 'BAN_AFG_SERIES': case 'ACC': case 'AFG_SL_SERIES':
			...
			case 'Control_F11':
				switch($('#selected_broadcaster').val().toUpperCase()){
				case 'BCCI': case 'TRI_SERIES': case 'BAN_AFG_SERIES': case 'AFG_SL_SERIES':
					dataToProcess = dataToProcess + ',' + document.getElementById('which_inning').value;
					processCricketProcedures("POPULATE-GRAPHICS", dataToProcess);
					break;
				case 'ACC':
			...
			case 'h':
				...
				case 'ACC':
					...
					processCricketProcedures("POPULATE-GRAPHICS", dataToProcess);
					break;
				case 'BCCI': case 'TRI_SERIES': case 'BAN_AFG_SERIES':
					addItemsToList(dataToProcess,null);
					break;	
				}
				break;
	...
	case 'Alt_d':
		...
		case 'Shift_~':
			...
			case 'Control_F12':
				...
				case 'BAN_AFG_SERIES': case 'ACC':
					...
					cellCount++;
					break;
				case 'BCCI': case 'TRI_SERIES': case 'AFG_SL_SERIES':
			        select = document.createElement('select');
			...
			switch($('#selected_broadcaster').val().toUpperCase()){
				case 'TRI_SERIES': case 'BAN_AFG_SERIES':  case 'ACC': case 'AFG_SL_SERIES':
				select = document.createElement('select');
		...
		case 'F12':
			...
			case 'BCCI': case 'TRI_SERIES': case 'AFG_SL_SERIES':
		        ...
		        switch($('#selected_broadcaster').val().toUpperCase()){	
				case 'TRI_SERIES': case 'AFG_SL_SERIES':
					select = document.createElement('select');
					select.id = 'selectRightBottom';
					select.name = select.id;
		...
		case 'Alt_7':
			...
			switch($('#selected_broadcaster').val().toUpperCase()){	
			case 'BCCI': case 'TRI_SERIES': case 'ACC': case 'AFG_SL_SERIES':
				select = document.createElement('select');
				select.id = 'selectRightBottom';
				select.name = select.id;
		...
		case "Alt_5":
			...
			select.name = select.id;
			switch($('#selected_broadcaster').val().toUpperCase()){
			case 'BCCI': case 'TRI_SERIES': case 'BAN_AFG_SERIES': case 'ACC':
				switch($('#selected_broadcaster').val().toUpperCase()){
					case 'BAN_AFG_SERIES': case 'ACC':
						const dropdown = [
		...
		case 'F7'://Lt Bat Profile
			...
			switch($('#selected_broadcaster').val().toUpperCase()){
				case 'TRI_SERIES': case 'BAN_AFG_SERIES': case 'ACC':
